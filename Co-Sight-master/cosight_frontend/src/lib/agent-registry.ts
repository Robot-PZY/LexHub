...
export const defaultAgentRegistry: AgentRegistry = {
  ...
  agents: [
    ...
    { id: 'research', name: '法规研究智能体', role: 'worker', modelLabel: 'DeepSeek / Tool', capabilities: ['法规检索', '引用溯源'], registeredTools: ['legal_search', 'tavily_search', 'search_google'], triggers: ['需要法律依据'] },
