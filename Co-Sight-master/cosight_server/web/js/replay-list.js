        ...
        if (result.code === 0 && result.data) {
            ...
            replayListEl.innerHTML = `
                <div class="no-data">
                    ...
                    <strong>暂无回放记录</strong>
                    <p>完成一次任务后，这里会展示可继续回放的历史工作区。</p>
                </div>
            `;
        }
    } catch (error) {
        ...
        <div class="replay-item" data-workspace="${workspace.workspace_path}">
            <div class="replay-item-header">
                <div class="replay-title-group">
                    <span class="replay-item-badge">历史任务</span>
            ...
            <div class="replay-item-info">
                ...
                <span><i class="fas fa-wave-square"></i> 支持完整过程回放</span>
            </div>
            <p class="replay-item-description">进入后可恢复该任务的执行流、查看阶段产物，并继续在法枢工作台中追问或补充材料。</p>
